	...
	public int drawSecondTable(Vector<GraphSimulationAgentState> agents, long width, int yValue) {
		...
		for (GraphSimulationAgentState ag : agents) {
			...
			y = createDynamicRow(
					...
					y,
					width,
					new String[] { String.valueOf(ag.energy) + "/" + String.valueOf(ag.maxEnergy), String.valueOf(ag.health) + "/" + String.valueOf(ag.maxHealth), String.valueOf(ag.strength), String.valueOf(ag.visRange),
							String.valueOf(ag.lastAction + " " + ag.lastActionParam + ":" + ag.lastActionResult) }, ag, ag.lastActionResult.startsWith("failed"));
		}
