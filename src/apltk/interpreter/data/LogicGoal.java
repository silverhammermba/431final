...
// Source File Name:   LogicGoal.java
...
public class LogicGoal extends Goal
{
    ...
    public LogicGoal(String predicate)
    {
        super("invalid");
        this.predicate = null;
        parameters = null;
    ...
    public LogicGoal(String predicate, Collection parameters)
    {
        super("invalid");
        this.predicate = null;
    ...
    public transient LogicGoal(String predicate, String parameters[])
    {
        super("invalid");
        this.predicate = null;
        this.parameters = null;
